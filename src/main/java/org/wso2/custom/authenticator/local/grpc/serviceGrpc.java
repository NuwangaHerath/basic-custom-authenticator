...
public final class serviceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<Service.Request,
      Service.Response> getGetRoleNameMethod;
  ...
  public static io.grpc.MethodDescriptor<Service.Request,
      Service.Response> getGetRoleNameMethod() {
    io.grpc.MethodDescriptor<Service.Request, Service.Response> getGetRoleNameMethod;
  ...
  public static abstract class serviceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getRoleName(Service.Request request,
  ...
  public static final class serviceBlockingStub extends io.grpc.stub.AbstractStub<serviceBlockingStub> {
    ...
    /**
     */
    public Service.Response getRoleName(Service.Request request) {
  ...
  public static final class serviceFutureStub extends io.grpc.stub.AbstractStub<serviceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<Service.Response> getRoleName(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_ROLE_NAME:
          serviceImpl.getRoleName((Service.Request) request,
              (io.grpc.stub.StreamObserver<Service.Response>) responseObserver);
          break;
        default:
